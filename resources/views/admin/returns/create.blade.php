            ...
            <div class="card transaction-form-card is-return">
                <div class="transaction-form-header">
                    <div class="transaction-form-title">
                        ...
                        <div>
                            <h4 class="mb-1">Tambah Pengembalian</h4>
                            <p class="mb-0 text-muted">Catat pengembalian aset, kondisi, dan berita acara.</p>
                        </div>
                    </div>
                ...
                <div class="card-body transaction-form-body">
                    ...
                    <form class="transaction-form" action="{{ route('admin.returns.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group transaction-field mb-0">
                                        ...
                                        <div class="transaction-input-shell transaction-textarea-shell">
                                            ...
                                            <textarea id="report_note" name="report_note" class="form-control @error('report_note') is-invalid @enderror" rows="4" placeholder="Catatan berita acara">{{ old('report_note') }}</textarea>
                                        </div>
                                        @error('report_note')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
