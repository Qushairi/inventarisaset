                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.returns.update', $returnRecord) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label for="verified_note">Catatan Pengembalian</label>
                                                <input type="text" id="verified_note" name="verified_note" class="form-control @error('verified_note') is-invalid @enderror" placeholder="Contoh: Diterima admin" value="{{ old('verified_note', $returnRecord->verified_note) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="status_note" name="status_note" class="form-control @error('status_note') is-invalid @enderror" rows="3" placeholder="Keterangan status">{{ old('status_note', $returnRecord->status_note) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="report_note">Catatan Berita Acara</label>
                                                <textarea id="report_note" name="report_note" class="form-control @error('report_note') is-invalid @enderror" rows="3" placeholder="Catatan berita acara">{{ old('report_note', $returnRecord->report_note) }}</textarea>
                                            </div>
                                        </div>
