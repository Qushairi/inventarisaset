            ...
            <div class="card transaction-form-card is-loan">
                <div class="transaction-form-header">
                    <div class="transaction-form-title">
                        ...
                        <div>
                            <h4 class="mb-1">Tambah Peminjaman</h4>
                            <p class="mb-0 text-muted">Catat aset, pegawai, periode, dan status peminjaman.</p>
                        </div>
                    </div>
                ...
                <div class="card-body transaction-form-body">
                    ...
                    <form class="transaction-form" action="{{ route('admin.loans.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group transaction-field">
                                        ...
                                        <div class="transaction-input-shell">
                                            ...
                                            <input type="date" id="loan_date" name="loan_date" class="form-control @error('loan_date') is-invalid @enderror" value="{{ old('loan_date') }}">
                                        </div>
                                        @error('loan_date')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group transaction-field">
                                        ...
                                        <div class="transaction-input-shell">
                                            ...
                                            <input type="date" id="planned_return_date" name="planned_return_date" class="form-control @error('planned_return_date') is-invalid @enderror" value="{{ old('planned_return_date') }}">
                                        </div>
                        ...
                        <div class="transaction-form-section">
                            ...
                            <div class="form-group transaction-field mb-0">
                                ...
                                <div class="transaction-input-shell transaction-textarea-shell">
                                    ...
                                    <textarea id="status_note" name="status_note" class="form-control @error('status_note') is-invalid @enderror" rows="4" placeholder="Keterangan status">{{ old('status_note') }}</textarea>
                                </div>
                                @error('status_note')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
